 ...
 *
 * Existing apps switch imports from "@step-harness/providers" to
 * "@step-harness/providers/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModels` from "@step-harness/providers/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@step-harness/providers/providers/all" or `Models.getProviders()`. */
